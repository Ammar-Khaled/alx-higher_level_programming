...
class Rectangle:
    ...
    def bigger_or_equal(rect_1, rect_2):
        ...
        Args:
            rec_1: the first compared rectangle
            rec_w: the second compared rectangle

        Raises:
            TypeError: if rect_1 or rect_2 is not a Rectangle object
    ...
    def square(cls, size=0):
        ...
        Args:
            size: size of the square to set for the new rectangle

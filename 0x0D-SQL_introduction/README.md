# MySQL - Introduction
This project has been done during **Software Engineering studies** at **ALX School**. It aims to learn about databases, relational databases, subqueries, tables, **MySQL** statements, functions and more.

## Technologies
* `MySQL 8.0` (version 8.0.33-0ubuntu0.20.04.2 for (Ubuntu))

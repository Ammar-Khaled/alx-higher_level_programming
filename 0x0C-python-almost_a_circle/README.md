# Almost a circle
Project done during **Software Engineering studies** at **ALX School**. It aims to learn about unit testing, serialization, deserialization, JSON, CSV, `args` and `kwargs` in **Python**.
